...
function preload() {
  for(i = 0; i<aantalBeeldjes;i++)
  {
      newImage = loadImage("images/sprites/Jos100px/Jos_" + i + ".png");
      animatie.push(newImage);
  }  
...
function draw() {
  ...
  image(animatie[nummer],xJos,yJos,0.5 * animatie[nummer].width, 0.5 * animatie[nummer].height);
}
